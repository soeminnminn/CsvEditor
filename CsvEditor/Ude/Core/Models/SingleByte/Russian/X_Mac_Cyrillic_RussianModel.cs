...
namespace Ude.Core.Models.SingleByte.Russian
{
    public class X_Mac_Cyrillic_RussianModel : RussianModel
    {
        private readonly static byte[] CHAR_TO_ORDER_MAP = {
            ...
            SYM, 71,172, 66,173, 65,174, 76,175, 64,176,177, 77, 72,178, 69, /* 6X */
             ...
             37, 44, 33, 46, 41, 48, 56, 51, 42, 60, 36, 49, 38, 31, 34, 35, /* 8X */
             45, 32, 40, 52, 53, 55, 58, 50, 57, 63, 70, 62, 61, 47, 59, 43, /* 9X */
            191,192,193,194,195,196,197,198,199,200,201,202,203,204,205,206, /* AX */
            207,208,209,210,211,212,213,214,215,216,217,218,219,220,221,222, /* BX */
            223,224,225,226,227,228,229,230,231,232,233,234,235,236,237,238, /* CX */
            239,240,241,242,243,244,245,246,247,248,249,250,251,NUM, 68, 16, /* DX */
              3, 21, 10, 19, 13,  2, 24, 20,  4, 23, 11,  8, 12,  5,  1, 15, /* EX */
              9,  7,  6, 14, 39, 26, 28, 22, 25, 29, 54, 18, 17, 30, 27,CTR, /* FX */
        };
        /*X0  X1  X2  X3  X4  X5  X6  X7  X8  X9  XA  XB  XC  XD  XE  XF */

        public X_Mac_Cyrillic_RussianModel() : base(CHAR_TO_ORDER_MAP, CodepageName.X_MAC_CYRILLIC)
        {
        }
    }
}