...
namespace Ude.Core.Models.SingleByte.Greek
{
    public class Iso_8859_7_GreekModel : GreekModel
    {
        ...
        public Iso_8859_7_GreekModel() : base(CHAR_TO_ORDER_MAP, CodepageName.ISO_8859_7)
        {
        }
    }
}