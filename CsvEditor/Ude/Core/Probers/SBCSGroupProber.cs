...
using Ude.Core.Models.SingleByte.Arabic;
using Ude.Core.Models.SingleByte.Bulgarian;
using Ude.Core.Models.SingleByte.Croatian;
using Ude.Core.Models.SingleByte.Czech;
using Ude.Core.Models.SingleByte.Danish;
using Ude.Core.Models.SingleByte.Esperanto;
using Ude.Core.Models.SingleByte.Estonian;
using Ude.Core.Models.SingleByte.Finnish;
using Ude.Core.Models.SingleByte.French;
using Ude.Core.Models.SingleByte.German;
using Ude.Core.Models.SingleByte.Greek;
using Ude.Core.Models.SingleByte.Hebrew;
using Ude.Core.Models.SingleByte.Hungarian;
using Ude.Core.Models.SingleByte.Irish;
using Ude.Core.Models.SingleByte.Italian;
using Ude.Core.Models.SingleByte.Latvian;
using Ude.Core.Models.SingleByte.Lithuanian;
using Ude.Core.Models.SingleByte.Maltese;
using Ude.Core.Models.SingleByte.Polish;
using Ude.Core.Models.SingleByte.Portuguese;
using Ude.Core.Models.SingleByte.Romanian;
using Ude.Core.Models.SingleByte.Russian;
using Ude.Core.Models.SingleByte.Slovak;
using Ude.Core.Models.SingleByte.Slovene;
using Ude.Core.Models.SingleByte.Spanish;
using Ude.Core.Models.SingleByte.Swedish;
using Ude.Core.Models.SingleByte.Thai;
using Ude.Core.Models.SingleByte.Turkish;
using Ude.Core.Models.SingleByte.Vietnamese;

#endregion using languages

namespace Ude.Core.Probers
{
