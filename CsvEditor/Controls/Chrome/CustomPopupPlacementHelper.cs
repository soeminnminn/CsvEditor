...
namespace CsvEditor.Controls
{
    ...
    internal static class CustomPopupPlacementHelper
    {
        ...
        private static CustomPopupPlacement CalculatePopupPlacement(CustomPlacementMode placement, Size popupSize, Size targetSize, Point offset, FrameworkElement child = null, Matrix transformToDevice = default)
        {
            Point point;
